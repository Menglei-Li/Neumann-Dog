...
options = {
    ...
    'lanczos':OFF,
    'libs':[],
    'listener_name':'DESKTOP-SOVR7TT',
    'listener_resource':'37520',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('desktop-sovr7tt', '192.168.124.18', '192.168.137.1'),
    'mp_host_list':(('desktop-sovr7tt', 4),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l NEW -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
